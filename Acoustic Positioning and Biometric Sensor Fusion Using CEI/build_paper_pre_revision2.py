...
OUT = "/home/claude/paper2_day1/paper2_revised_v9_camera_ready.pdf"
...
def build():
    ...
    story.append(Paragraph(
        ...
        "under the jamming scenario). Among the evaluated approaches, CEI "
        "achieves the strongest combined governance-compliance and bandwidth-"
        "efficiency performance under adversarial conditions.",
        abstract_body))
